  ...
  return (
    ...
    >
      <Routes>
        ...
        {/* Files page (2026-09-20 檔案頁 §4): every role sees their OWN
            uploads + outputs; an admin can additionally switch to every
            user's (2026-09-21 管理視角) and delete on their behalf. */}
        <Route path="/files" element={<Files role={role} />} />
