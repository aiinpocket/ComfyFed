/**
 * This file embeds the only copy of the panel extension JS (originally the
 * Python server's `panel_ext/comfyfed.js`, 2026-09), the one real
 * `/comfy/api/extensions` entry. The former Python server served the file
 * straight off disk via
 ...
 *
 * The former `test/comfyfed-ext.spec.ts` byte-compared this constant against
 * the Python-side file; with that file gone (2026-09) this constant is the
 * source of truth and is edited here directly.
 */
