 ...
 * the former Python server exactly:
 *
 ...
 *    treats it as unauthenticated, same as the former Python `_session_user_from_
 ...
 *    the former Python server invalidated EVERY outstanding session by overwriting the
 ...
 *
 * Tamper-detection note (the point made by the former Python suite's
 * `test_read_session_payload_rejects_absent_and_tampered_cookies`):
