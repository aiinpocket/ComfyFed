...
// ---------------------------------------------------------------------------
// PyPI response parsing -- ports official_templates.py's `_parse_sub_packages`
...
// unlike comfy_frontend.py's frontend bundle: the set of sub-packages and
...
// ---------------------------------------------------------------------------
// Zip-slip-safe flattening -- byte-for-byte port of `official_templates.py`'s
...
// ---------------------------------------------------------------------------
// Per-file RECORD verification -- a check `official_templates.py` does NOT
// do (it only verifies the whole wheel's sha256 against PyPI's digest); this
