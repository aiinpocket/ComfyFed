/**
 * `GET /install.ps1|.sh|.cmd` and `GET /api/platform` -- coverage originally
 * ported from the Python suite onto `routes/installer.ts`.
 * See `routes/installer.ts`'s own docstring for the binding
 ...
 * by `test/global-setup.ts` from `cloud/packaged/installers/` --
