...
// ---------------------------------------------------------------------------
// DELETE /api/workers/{id} -- admin soft delete (ports the original Python
// suite's delete section; the live-socket kick lives in hub.spec.ts)
...
// block of the original Python suite.
