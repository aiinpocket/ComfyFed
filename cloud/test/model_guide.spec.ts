...
// Ports the highest-value cases from tests/server/test_model_guide.py -- see
// that file for the full Python suite this mirrors. R2-backed `harvest()`
// replaces Python's local-disk `official_templates.official_dir` scan (see
...
describe("SOURCES (curated registry)", () => {
  it("has exactly eleven entries, all resolvable via lookup()", async () => {
