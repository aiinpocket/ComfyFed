...
describe("cloud end-to-end", () => {
  ...
  it(
    ...
    async () => {
      ...
      // same way the former Python `entries()` signed one.
  ...
  //
  // Parity twin of the original Python suite's
  ...
  it(
    ...
    async () => {
      ...
      // 含切片長度的自己的簽章。與原 Python 測試套件的同一個 e2e 同步。
...
//
// Parity twin of the original Python suite's `test_e2e_*` peer block.
//
